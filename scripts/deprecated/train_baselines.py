"""
DEPRECATED: This script saves test probabilities for threshold tuning (data leakage).
Use scripts/retrain_end_to_end.py for proper CV-based threshold selection.
"""
